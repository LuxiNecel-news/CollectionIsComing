...
githubRepos = {'pg-ufr-news/germanExtremes': {'Language':'de'}, 
               ...
               'TinoH91news/romanianExtremes': {'Language':'ro'},
              }
...
def storeCollection():
    ...
    cols = ['published','extreme','topic','domain','language','valid', 'title','description', 'url','image','archive', 'content','en','de','la', 'country','ipcc','continent', 'feed']
